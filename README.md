...
_The International Chronostratigraphic Chart from the International Commission on Stratigraphy, in computer-readable formats._
...
[strat2file](https://github.com/TobbeTripitaka/strat2file/blob/master/strat2file.ipynb) is the code just to convert an Excel spreadsheet to JSON, XML, etc. 

[strat2my](https://github.com/TobbeTripitaka/strat2file/blob/master/strat2my.ipynb) is a function that takes a string of geological time and converts it to a number, e.g. Permian to 'average age', start and end: 
get_time('Danian') 
(63.8, 61.6, 66.0)
